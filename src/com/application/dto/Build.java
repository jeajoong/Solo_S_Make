...
public class Build { // 조인된 쿼리 내용 추가한 건축물대장 VO객체
  ...
  private String upperBuildingPK;  // 상위 건축물대장 키
  ...
  public String toString() {
    return "Build [bldTypeGBCD=" + bldTypeGBCD + ", buildingPK=" + buildingPK + ", regstrGBCD="
        ...
        + ", upperBuildingPK=" + upperBuildingPK + ", naRoadCD=" + naRoadCD + ", naBjdongCD="
        + naBjdongCD + ", naGrndUgrndCD=" + naGrndUgrndCD + ", naMainBun=" + naMainBun
        + ", naSubBun=" + naSubBun + ", operSrvrRflcYN=" + operSrvrRflcYN + ", mainAtchGBCD="
        + mainAtchGBCD + ", platNewLoc=" + platNewLoc + ", upDownCNT=" + upDownCNT + "]";
  }
  ...
  public String getUpperBuildingPK() {
    return upperBuildingPK;
  }

  public void setUpperBuildingPK(String upperBuildingPK) {
    this.upperBuildingPK = upperBuildingPK;
  }
