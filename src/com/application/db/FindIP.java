...
public class FindIP {
  ...
  public String findCom(String sigunguNum) {
    ...
    if( sigunguCD == 11230 || sigunguCD == 11260 || sigunguCD == 11290 ||
        ...
        sigunguCD == 48330 || sigunguCD == 48720) {
      String comIP = null;
      comIP = "192.168.0.102";
      return comIP;
    }
    if( sigunguCD == 11350 || sigunguCD == 11380 || sigunguCD == 11410 ||  
        ...
        sigunguCD == 48840 || sigunguCD == 48850) {
      String comIP = null;
      comIP = "192.168.0.103";
      return comIP;
    }
    ...
    if( sigunguCD == 26260 || sigunguCD == 26290 || sigunguCD == 26320 ||  
        ...
        sigunguCD == 47290 || sigunguCD == 47720) {
      String comIP = null;
      comIP = "192.168.0.107";
      return comIP;
    }
    if( sigunguCD == 26410 || sigunguCD == 26440 || sigunguCD == 26470 ||  
        sigunguCD == 26500 || sigunguCD == 26530 || sigunguCD == 26710 ||  
        sigunguCD == 42770 || sigunguCD == 42780 || sigunguCD == 42790 ||  
        sigunguCD == 42800 || sigunguCD == 42810 || sigunguCD == 42820 ||  
        sigunguCD == 42830 || sigunguCD == 44770 || sigunguCD == 44790 ||  
        sigunguCD == 44800 || sigunguCD == 44810 || sigunguCD == 44825 ||  
        sigunguCD == 45111 || sigunguCD == 45113 || sigunguCD == 47730 ||  
        sigunguCD == 47750 || sigunguCD == 47760 || sigunguCD == 47770 ||  
        sigunguCD == 47820 || sigunguCD == 47830 || sigunguCD == 50110) {
      String comIP = null;
      comIP = "192.168.0.108";
      return comIP;
      }
    if( sigunguCD == 27110 || sigunguCD == 27140 || sigunguCD == 27170 ||  
        sigunguCD == 27200 || sigunguCD == 31110 || sigunguCD == 31140 ||  
        sigunguCD == 31170 || sigunguCD == 43111 || sigunguCD == 43112 ||  
        sigunguCD == 43113 || sigunguCD == 43114 || sigunguCD == 43760 ||  
        sigunguCD == 43770 || sigunguCD == 43800 || sigunguCD == 45130 ||  
        sigunguCD == 45140 || sigunguCD == 45180 || sigunguCD == 45190 ||  
        sigunguCD == 45210 || sigunguCD == 45710 || sigunguCD == 47840 ||  
        sigunguCD == 47850 || sigunguCD == 47900 || sigunguCD == 47920 ||  
        sigunguCD == 47930 || sigunguCD == 47940) {
      String comIP = null;
      comIP = "192.168.0.109";
      return comIP;
    }
    if( sigunguCD == 27230 || sigunguCD == 27260 || sigunguCD == 27290 ||  
        sigunguCD == 27710 || sigunguCD == 31200 || sigunguCD == 31710 ||  
        sigunguCD == 36110 || sigunguCD == 43130 || sigunguCD == 43150 ||  
        sigunguCD == 43720 || sigunguCD == 43730 || sigunguCD == 43740 ||  
        sigunguCD == 43745 || sigunguCD == 43750 || sigunguCD == 45720 ||  
        sigunguCD == 45730 || sigunguCD == 45740 || sigunguCD == 45750 ||  
        sigunguCD == 45770 || sigunguCD == 45790 || sigunguCD == 45800 ||  
        sigunguCD == 48121 || sigunguCD == 48123 || sigunguCD == 48125 ||  
        sigunguCD == 48127 || sigunguCD == 48129) {
      String comIP = null;
      comIP = "192.168.0.110";
      return comIP;
    }
